...
[Post](You and Me Learn All About HTTP with Safia Abdalla)

---

## To Kill a Working Drone: Flying drones with Twitter, Bananas and WebAPIs with Lucky Nkosi

[Post](https://dev.to/luckynkosi/to-kill-a-working-drone-flying-drones-with-twitter-bananas-and-webapis-with-lucky-nkosi-4l98)
...
[Post](https://dev.to/humblefool_2/machine-learning-on-the-edge-with-sangeetha-kp-5509)
...
[Post](https://dev.to/brianverm/live-exploiting-your-open-source-dependencies-with-brian-vermeer-3g)

---

## Printing floating point numbers with Gargi Sharma

[Post](https://dev.to/gs0510/printing-floating-point-numbers-with-gargi-sharma-24fl)

---

## Emoji Encoding, Unicode, and Internationalization with Naomi Meyer

[Post](https://dev.to/naeohmi/emoji-encoding-unicode-and-internationalization-with-naomi-meyer-34d3)
