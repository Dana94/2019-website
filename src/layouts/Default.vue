      ...
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="social-icons">
          <li class="flex justify-center items-center">
            <a href="https://docs.google.com/document/d/1Oo7dxyvFD4rnVWkhZn1wP6BzO_lNRR_iGHxegOg6Dfw/edit?usp=sharing" target="_blank" aria-label="resume" class="text-white hover:text-gray-400">
          ...
          <li class="flex justify-center items-center">
            <a href="https://dev.to/dana94" target="_blank" aria-label="DEV profile" class="text-white hover:text-gray-400">
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
