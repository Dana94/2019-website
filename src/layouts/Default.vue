      ...
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="social-icons">
          <li class="flex justify-center items-center">
            <a href="https://docs.google.com/document/d/17YrN4uSYJdU_Lk0B05p2MS1rBNsYg6wTS8HfFFk_8fc/edit?usp=sharing" target="_blank" aria-label="resume" class="text-white hover:text-gray-400">
