      ...
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        <div class="mb-8 lg:mb-0">
          ...
          <div>
            ...
            <a href="https://icons8.com/" target="_blank" rel="noopener noreferrer" class="hover:text-purple-300">icons8</a>.
          </div>
          <div>
            <a href="https://github.com/Dana94/website" target="_blank" rel="noopener noreferrer" class="hover:text-purple-300">View Source</a>
          </div>
        </div>
        <ul class="social-icons">
          <li class="flex justify-center items-center">
            <a href="https://docs.google.com/document/d/17YrN4uSYJdU_Lk0B05p2MS1rBNsYg6wTS8HfFFk_8fc/edit?usp=sharing" target="_blank" rel="noopener noreferrer" aria-label="resume" class="text-white hover:text-gray-400">
          ...
          <li class="flex justify-center items-center">
            <a href="https://dev.to/dana94" target="_blank" rel="noopener noreferrer" aria-label="DEV profile" class="text-white hover:text-gray-400">
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
